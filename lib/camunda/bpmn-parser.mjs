 ...
 * @param {String} bpmnFilepath - `.bpmn` filepath to parse
 * @param {String} resourcesPath - base path to lookup for resources linked to `.bpmn` files
 * @param {String[]} incomingChanges - list of resources that has been detect modifications
 * @returns {BpmnParsedData} BpmnData parsed object data
 */
