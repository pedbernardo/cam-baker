 ...
 * @property {String=} envPrefix - exposed env variables prefix to esbuild (default: PUBLIC_)
 */
 ...
 * @property {String=} version - Camunda Run version to be used (default: 7.18)
 * @property {Boolean=} autoDeploy - enables auto-deploy feature (default: false)
 * @property {Boolean=} autoMigration - enables auto-migration feature (default: false)
 */
 ...
 * @property {CamundaRunConfig=|Boolean=} camundaRun - enables usage of Camunda Run directly by the CLI
 */
...
export function resolveFormDependencies ({ filepath, config }) {
