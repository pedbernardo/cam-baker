...
function bundle ({ target, outDir, variables }, onFileBuild) {
...
export async function buildJavascript ({ target, outDir, variables }, onFileBuild) {
  const { entry, output } = target
